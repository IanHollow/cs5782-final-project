...
CHECKED_IN_SUMMARY_PATH = Path("results/summary_table.csv")
CHECKED_IN_RANKED_PATH = Path("results/benchmark_summary_rank.csv")
...
def load_results(results_dir: Path | None) -> pd.DataFrame:
    ...
    if rows:
        ...
        msg = (
            "No metrics.json files found and results/summary_table.csv is missing. "
