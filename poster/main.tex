...
\headlineMetric{79.20\%}{Full \dora{} macro} &
\headlineMetric{+1.79}{accuracy points} &
\headlineMetric{6/1/1}{wins/ties/losses}
\end{tabularx}
\endgroup
\vspace{0.8ex}
\begin{center}
...
Full-scope \dora{} reproduced the paper's qualitative improvement over \lora{} under our student-scale setup.
\end{minipage}
\end{center}
\end{alertblock}
